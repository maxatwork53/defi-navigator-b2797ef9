...
const TvlToFeesRatioChart = memo(({
  data
}: TvlToFeesRatioChartProps) => <div className="bg-card rounded-lg border shadow-sm p-6">
    <h3 className="text-lg font-medium mb-4">TVL to Fees Ratio (24h)</h3>
      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        bottom: 60
          ...
          if (active && payload && payload.length) {
            ...
            return <div className="bg-background p-3 rounded-md border text-xs shadow">
