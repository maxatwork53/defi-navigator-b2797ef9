...
const PositionMetricsStats = ({
  overall,
  winning,
  losing
}: PositionMetricsStatsProps) => {
  ...
  return <Card className="mb-4">
      <CardContent className="pt-6 py-[7px]">
        ...
        <div className="grid grid-cols-7 gap-2 mb-1 border-b pb-1">
          ...
          {overall.value.bottomQuartile !== undefined && <div className="font-medium text-xs">Bottom Quartile</div>}
          {overall.value.topQuartile !== undefined && <div className="font-medium text-xs">Top Quartile</div>}
        ...
        <div className="grid grid-cols-7 gap-2 py-1">
          ...
          {overall.value.bottomQuartile !== undefined && <div className="text-xs font-medium">{formatValue(overall.value.bottomQuartile, 'value')}</div>}
          {overall.value.topQuartile !== undefined && <div className="text-xs font-medium">{formatValue(overall.value.topQuartile, 'value')}</div>}
        ...
        <div className="grid grid-cols-7 gap-2 py-1">
          ...
          {overall.priceRange.bottomQuartile !== undefined && <div className="text-xs font-medium">{formatValue(overall.priceRange.bottomQuartile, 'range')}</div>}
          {overall.priceRange.topQuartile !== undefined && <div className="text-xs font-medium">{formatValue(overall.priceRange.topQuartile, 'range')}</div>}
        ...
        <div className="grid grid-cols-7 gap-2 py-1">
          ...
          {overall.timeInPosition.bottomQuartile !== undefined && <div className="text-xs font-medium">{formatValue(overall.timeInPosition.bottomQuartile, 'time')}</div>}
          {overall.timeInPosition.topQuartile !== undefined && <div className="text-xs font-medium">{formatValue(overall.timeInPosition.topQuartile, 'time')}</div>}
